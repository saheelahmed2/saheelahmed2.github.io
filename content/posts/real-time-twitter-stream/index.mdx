...
4. Install [Tweepy](http://docs.tweepy.org/en/v3.5.0/getting_started.html#introduction)

```sh
pip install tweepy
```

5. Go to your `flask` folder open scripts and run `activate` on terminal to start the server.
...
6. Now go to repository and run `app.py` on terminal to start the application.
...
7. Go to your [http://localhost:8080](http://localhost:8080) And that's it !!
