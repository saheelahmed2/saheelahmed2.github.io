...
is difficult to obtain or even fake; therefore, its performance and application range suffer from significant limitations. 

**Collaborative filtering** algorithms are the most widely used algorithms in recommendation systems; they are different from content-based methods in that 
...
A third and more popular approach is **Modal based filtering** algorithm. The model-based methods are developed with
